...
<!-- We also feel inclined to note, since this is a common misunderstanding, that Björn Pankratz, which is most popular at the nominal Piranha Bytes of today, did not play much of a role in the creation of GOTHIC, as one can easily see for oneself by looking up the credits of the game. He was neither involved in the founding of the company, nor in the creation of the setting, nor in the story design. He had a minor role, starting in QA, made some additional sound effects, some programming administration and is credited for "additional game design". But the actual creators of GOTHIC are and will always be the four founders and the Mad Scientists. The people that were most influential on GOTHIC other than those are without any doubt Mattias Filler for the story, Uwe Meier & Ralf Marczinszik for the additional art design, Sascha Henrichs & Mariö Röske for the world modeling, Vadim Pietrzynski for the early monster design, Carsten Edenfeld for programming, Horst Dworczak, and maybe Markus Kark and André Hotz, as well as Kai Rosenkranz for the music and sound and the many little things he also did, such as special effects. Björn Pankratz, compared to all of these, did play a very minor role in GOTHIC. This changed with what would become "Gothic 2", but this is a different story that we do not want to deal with here. 
{: .subtext }-->
...
<!--
 Aktuell arbeiten wir an <a href="/">PHOENIX</a> und sind verantwortlich für das <a href="https://gothicarchive.org" target="_blank">Gothic Archiv</a>. Auf unserer Website (<a href="https://phoenixtales.de" target="_blank">phoenixtales.de</a>) beschreiben wir uns als "unabhängige Entwickler immersiver Geschichten (tales) [...]", die, wie ein Phoenix, "aus der Asche der Industrie auferstehen". Damit meinen wir die Spieleindustrie, die alles dem Profit unterwirft, während wir einen anti-kommerziellen Ansatz verfolgen und der industriellen Spieleproduktion eine liebevolle Handarbeit entgegensetzen, die sich um Profit nicht kümmert.</p>
  ...
  <p>In diesen beiden Artikeln sind nähere Infos über uns zu finden:<br>
    * <a href="https://phoenixtales.de/dev/logo.html" target="_blank">Making of Phoenix Tales</a><br>
    * <a href="https://phoenixthegame.com/specials/phoenixdevs.html" target="_blank">Phoenix Tales: The Team behind PHOENIX</a>
  </p>
  </details>
-->
...
GOTHIC (2001) is a CRPG by [Piranha Bytes](#who-was-piranha-bytes) and the [Mad Scientists](#who-were-the-mad-scientists). The name *Gothic* was an idea by Bert Speckels in early 1998, which still reminds of the name of their Demo "Finster". The main inspiration was [*Escape from New York*](https://www.imdb.com/title/tt0082340/). It was basically supposed to be *Escape from New York* in a sword & sorcery setting. Mike Hoge developed the world map and most of the setting, with the different camps on the surface, the underworld, all of which were modeled in a rough form by Tom Putzki. Mike developed the different factions and a rough draft of the story, which was then elaborated on by Stefan Nyul and Mattias Filler and several other supporting story authors, namely Carsten Kisslat, Navid Vahdat, Jörg Bütow, Florian Jacobi, Stefan Kalveram and Steffen Rühl. These are the men who were responsible for the story and setting of Gothic (there are others that are often wrongly claimed to be responsible for the creation of Gothic by the Press and the general public, while they aren't). 

Alex Brüggrmann was instrumental too for many aspects of the setting and the animations that brought the world to life. Ralf Marczinczik helped Mike to develop the world visually, Uwe Meier was responsible for the final character design and Horst Dworzcak and Sascha Henrichs for the final world model. 

This went on till 2000, when the story had been re-iterated several times until the radical cut at the end of the development, when most of the things that all these supporting story authors had written were radically removed. As the project had been in development since 1996 and was originally supposed to be released in 1998, with one delay after another, it was almost cancelled. The cut was necessary in order to safe the release, but the result was a game that was, in fact, a mere fraction of what it was once supposed to be, both story- and feature-wise. 

The game was released in 2001 at March 15th, with a lot of bugs, an incomplete story and a plethora of content and features which could not be realised in time, which were either cut or left undone. In many cases those features were worked on for a long time and were planned, publicly announced and widely promoted since 1998. Gothic was revolutionary and it is still today to a degree, but much more revolutionary is its potential, which was not utilised, the vision it is based on, which we are roughly characterising in a simplified way as "the Alpha". In order to understand more of what Gothic was really meant to be read the articles linked below. 

The first working title of the project was 'Orpheus' (all [related concepts](https://gothicarchive.org/documents/OrpheusDocs.html) that we published belong solely to Mike Hoge). After the ruin of Greenwood Entertainment and the founding of Piranha Bytes, the project was resurrected under the working title 'Phoenix' (that we are using today to signify our goal to bring this old vision back to life). 
...
Soon the camp splits apart again in a conflict of Lee and a part of the mages with the barons. At first they hide in caves from their persecutors, until they find a new home and build a new camp, in which all those take refuge who despise the rule of the barons and refuse to cooperate with the king. The palisade surrounding the Old Camp is built in consequence of this conflict. 

The New Camp cooperates with the "Scraper's Union", an anarchist community of free diggers with their own mine. Together they work on a plan to escape from the prison. 
...
<!--
  <details>
  <a id="gothic"></a>
  <summary>Was ist Gothic?</summary>
  <p>
  <a href="https://www.gog.com/game/gothic">GOTHIC</a> (2001) ist ein Action Computer Rollenspiel von Piranha Bytes und den Mad Scientists. Der Name <i>Gothic</i> war eine Idee von Bert Speckels (im Februar 1998?), der noch immer an den Namen ihrer Demo 'Finster' erinnert. Statt der von den Mad Scientists ursprünglich geplanten First Person Perspektive, entschieden sie sich für eine Third Person Perspektive ala Tomb Raider. Inspiriert von <a href="https://www.imdb.com/title/tt0082340/">Escape from New York</a> hatte Stefan Nyul die Idee, ihr Spiel in einem abgeschlossenen Gefängnis spielen zu lassen. Damit war der Rahmen der Spielwelt gesetzt. Mike Hoge zeichnete eine <a href="https://gothicarchive.org/conceptart/mikehoge/maps.html">erste Karte</a> der Spielwelt, entwickelte die verschiedenen Lager und die Unterwelt, erdachte sich die in den Lagern lebenden Fraktionen und arbeitete auf dieser Grundlage die Geschichte aus. 'Orpheus' war der erste Arbeitstitel des Projekts. Nach dem Untergang von Greenwood Entertainment und der Gründung von Piranha Bytes, wurde das Projekt unter dem Arbeitstitel 'Phoenix' wieder aufgenommen.</p>

  <p>GOTHIC spielt im Königreich Myrtana. Die Orks sind vor dem Rassenhass der Menschen in den Untergrund geflohen und haben sich unterirdische Städte erbaut. Eine dieser Städte liegt im Minental von Khorinis. Aus ganz Myrtana werden Sträflinge in die Minenkolonie gebracht, um dort Erz für den Krieg zu fördern. Das Reich ist im Krieg mit den Orks. Um jede Flucht unmöglich zu machen und den Nachschub an magischem Erz zu sichern, das im Tal von Khorinis abgebaut wird und kriegsentscheidend sein soll, lässt der König von seinen Magiern eine magische Barriere um das Tal errichten. Doch statt totaler Kontrolle schaffen sie Chaos. Als das Ritual schief geht und die Magier mit einschließt, bricht im Gefängnis eine Revolte aus. Die Gefangenen töten die Wärter und bringen das Gefängnis unter ihre Kontrolle. Es entsteht ein Lager um die ehemalige Gefängnisfestung im Zentrum des Tals und eine neue Machtstruktur.</p>

  <p>Unterdrückt von den Stärksten, die sich in der Revolte durchgesetzt haben, den "Erzbaronen" und ihrer Garde, die die Uniformen der ehemaligen Wärter übernimmt, werden die 'Buddler' zur Arbeit in den Minen gezwungen, um dem König weiterhin Erz zu liefern, der im Gegenzug die Forderungen der Barone erfüllt. Schon bald spaltet sich das alte Lager und ein neues Lager entsteht, in dem all jene Zuflucht suchen, die der Herrschaft der Erzbarone entkommen wollen. Sie erschließen eine eigene Mine und arbeiten an einem Ausbruchsplan.</p>

  <p>Die Visionen eines Buddlers lassen ein drittes Lager im Sumpf entstehen: Eine Bruderschaft, die den alten Göttern abgeschworen hat und nun den 'Schläfer' anbetet, der, wie sie glauben, wenn er erwacht, sie aus dem Gefängnis befreien wird. So arbeiten sie unermüdlich an seiner Erweckung.</p>

  <p>Der Spieler wird in dieses Gefängnis geworfen. Er kann sich aussuchen, welcher Fraktion er sich anschließt und welchen Weg er einschlägt (Krieger, Magier, Dieb oder Psioniker), um das Spielziel zu erreichen: Freiheit.</p>

  <p>Das Spiel erschien am 15. März 2001, mit vielen Bugs, einer unvollständigen Story und einer großen Menge an fehlenden Inhalten (Cut-Content), die angekündigt, zum Teil bereits angelegt oder zumindest geplant waren. GOTHIC war damals und ist heute revolutionär, doch viel mehr noch ist es sein nicht ausgeschöpftes Potential, die ihm zugrundeliegende Vision, die wir grob als 'die Alpha' charakterisieren.</p>
  </details>
  -->
...
<!--
  <details>
  <a id="sequel"></a>
  <summary>Was ist das Gothic Sequel?</summary>
  <p>Das GOTHIC 'Sequel' war ein gleichnamiges Projekt von Alex Brüggemann und Stefan Nyul, zwei der zu diesem Zeitpunkt drei verbliebenen Gründer von Piranha Bytes (Mike arbeitete zu dieser Zeit an einem Sci-Fi Shooter Projekt mit dem Arbeitstitel 'Unplugged'). Mit dem Sequel wollten sie die Geschichte von Gothic in vier neuen Kapiteln weiter erzählen. Von den vier geplanten Kapiteln wurde nur das erste Kapitel in Bruchteilen realisiert, ehe die Entwicklung abgebrochen wurde. Es kam zu einem Konflikt um die Fortsetzung von GOTHIC, in dessen Folge Piranha Bytes zerbrach. Die Arbeit am Sequel musste eingestellt werden, Alex und Stefan und die meisten anderen Sequel Entwickler verließen Piranha Bytes oder mussten gehen. Und stattdessen wurde Gothic 2 in Auftrag gegeben, jetzt unter Leitung von Mike Hoge.</p>

  <p>Mit der Veröffentlichung von Gothic 2 geriet das Gothic Sequel in Vergessenheit, zirkulierte aber in einem kleinen Kreis der Community in Form des letzten Builds v1.12f. Über Story und Inhalt des Sequels war zu diesem Zeitpunkt außerhalb dieses kleinen Zirkels wenig bekannt. 16 Jahre später (2017) kam es zu einem Leak dieser Version. Zu diesem Zeitpunkt arbeiteten wir gerade seit etwa einem Monat an unserer Rekonstruktion des Sequels.</p>
  </details>
-->
...
This is an uninformed assumption that lacks critical reflection. We can say with little doubt that no one has studied the development history of Gothic more than we did. We are aware of the nature of decisions, and they are not homogenous. Decisions were made, sometimes deliberately and sometimes forced. They were made sometimes out of conviction and at other times out of necessity. They were sometimes made merely out of the pressure of time or due to technical problems and not out of conviction.  
The developers announced critical features and promised to offer a particular experience in interviews and promotional material, and then got rid of these features in the end and offered a very different and more limited experience (differing from what they themselves once imagined). When that happened (and it happened in many areas), they often did not do so because they wanted to, but because they had to. 
...
<!--
  <details>
  <a id="phoenix"></a>
  <summary>Was ist PHOENIX?</summary>

  <p><a href="/">PHOENIX</a> (Arbeitstitel 'Project Nyx') ist eine 'Revision' von GOTHIC als ein Drama in zwei Akten (<i>Orpheus</i> und <i>Nemesis</i>) (or Eurydice?). Wir verstehen PHOENIX als ein GOTHIC Reboot, ein Wiedererwachen der Alpha Versionen und des vergessenen Sequels, aber es enthält auch viele eigene Ideen von uns.</a></p>

  <p>PHOENIX ist eine <em>Immersive Sim</em>, deren <em>Dramatis Personae</em> sich mit persönlichen, psychologischen und metaphysischen Themen auseinandersetzen; unsere kleine, handgestaltete Spielwelt sehen wir als Bühne eines Dramas. </p>

  <p>Der Name <i>Nyx</i> (die Göttin der Nacht) nimmt Bezug auf die beiden Namen '<a href="https://gothicarchive.org/demos/finster/" target="_blank">Finster</a>' und 'Gothic' und so auf den dem Spiel innewohnenden, düsteren Stil. Es nimmt Bezug auf Orpheus (den ersten Arbeitstitel von Gothic): Die Lehre der Orphiker besagt, Nyx, die Nacht, sei der Anfang aller Dinge. Und es nimmt Bezug auf Nemesis (den vielleicht besten Teil der (verworfenen) Gothic Story, der das Sequel mit inspiriert hat): Nemesis ist eine Tochter der Nyx.</p>

  <p>Wir versuchen, die Essenz der Vision hinter Gothic zu ergründen und zu verfeinern. Es geht uns darum, die Designgrundsätze hinter Gothic konsequent weiter zu verfolgen, um sowohl den besonderen Stil als auch den Inhalt von Gothic weiterzuentwickeln.</p>

  <p>In Akt I haben wir das Design, die Story, das Gameplay usw. der 'Gothic Alpha' (womit wir alle verworfenen Inhalte zusammenfassen, siehe <a href="https://gothicarchive.org">Gothic Archiv</a>) analysiert; hier sammeln und rekonstruieren wir den Cut-Content und sämtliche Konzepte und schöpfen das Potential der Vorlage aus, um in Akt II, nahtlos an unsere Rekonstruktion der Alpha anknüpfend, das gecancelte Gothic Sequel wiederzubeleben und auf eigene, kreative Weise zu Ende zu führen.</p>
  </details>
  -->
...
<!--
  <details>
  <a id="orpheus"></a>
  <summary>Was ist Orpheus (Akt I)?</summary>
  <p>ORPHEUS ist der erste Akt von PHOENIX und stellt für uns das dar, was GOTHIC hätte sein sollen. Es ist der erste Akt unseres Dramas und damit der erste Teil von PHOENIX, mit dem Ziel, die Gothic Alpha Versionen mit all ihren verworfenen Inhalten, die ursprünglich geplante Story und sämtliche Ideen und Konzepte spielbar zu rekonstruieren. Wir haben den ersten Akt unseres Dramas 'Orpheus' genannt, weil es der erste Arbeitstitel zu Gothic war.</p>
  </details>
-->
...
<!--
  <details>
  <a id="nemesis"></a>  
  <summary>Was ist Nemesis (Akt II)?</summary>
  <p>NEMESIS ist der zweite Akt unseres Dramas, mit dem Ziel, das nie fertig gestellte Gothic Sequel zu rekonstruieren und zu vervollständigen, jedoch basierend auf unserer Alpha Version der Welt, Lore und Story, wie wir sie im Rahmen von Orpheus entwickelt haben.</p>
  <p>Unser Akt II bildet eine vollwertige Fortsetzung zu(r) Gothic (Alpha), die den Namen verdient und die alte Vision von Stefan Nyul und Alex Brüggemann realisiert.</p>
  <p>Nemesis (die Göttin der Rache oder des 'gerechten Zorns') war der interne Name eines zentralen Events am Ende der Alpha Story, im Bezug auf die Konsequenzen der Flucht der Orks aus der Orkstadt, für die der Spieler verantwortlich ist. Was an dieser Stelle der Story in Orpheus geschieht bildet zugleich die Grundlage für die Ausgangssituation des Gothic Sequels. Wegen dieser essentiellen, aber verworfenen Aspekte der Story und den damit verbundenen, tiefgründigen Implikationen (die Schuldfrage des Spielers, der Held als Anti-Held usw., die wir in unserem Sequel ausbauen wollen) haben wir diesen Namen für den zweiten Akt unseres Dramas gewählt.</p>
...
<!--
  <details>
  <a id="gothic2"></a>
  <summary>Was ist mit "Gothic 2"?</summary>
  <p>'Gothic II' ist kein Bestandteil der PHOENIX Lore. Phoenix steht in der Tradition der ursprünglichen Ideen zu GOTHIC und des für GOTHIC charakteristischen Artdesigns, mit denen Gothic II grundlegend gebrochen hat. Gothic II ist mit der Gothic I Lore, dem Setting und Design nicht in Einklang zu bringen und wird darum von uns in keiner Weise berücksichtigt.</p>  
    
  <p>Ein weiterer Konflikt entsteht durch das Gothic Sequel. Das Sequel und Gothic II basieren auf unterschiedlichen Designansätzen und erzählen eine vollkommen andere Geschichte. Das Sequel stellt eine ältere, geplante Fortsetzung zu Gothic dar und ist damit als Alternative zu Gothic II zu sehen. Da wir die fragmentarische Story von Gothic vervollständigen und die Geschichte im Sinne der ursprünglich geplanten Story fortsetzen wollen, konnten und wollten wir Gothic II dabei nicht berücksichtigen.</p>
  
  <p>PHOENIX ist ein Reboot von GOTHIC und sollte als eigenständiges Universum betrachtet werden, das die ursprünglich geplante Geschichte realisiert und sie auf Basis der Ideen des Sequels weiter erzählt.</p>
  </details>
-->
...
<!--
  <details>
  <a id="canon"></a>
    <summary>Was ist Gothic/Phoenix Kanon?</summary>
    <p>Die Frage nach "dem" Kanon macht nur Sinn in einem Universum, das kohärent ist. Die Gothic Reihe hat diese Kohärenz bereits durch Gothic 2 eingebüßt, das im Hinblick auf Setting, Lore und Artstyle mit dem Gothic Universum gebrochen hat.</p>
    <p>Wenn es einem nur um den "offiziellen" Kanon geht, ist diese Frage im Bezug auf GOTHIC nur sehr schwer zu beantworten und jede Antwort erweist sich als bedeutungslos. "Offiziell" ist die Aussage des Rechteinhabers, die sich aber nicht mit den Aussagen des Erfinders deckt, was nur noch verwirrender wird dadurch, dass die Lore und Geschichte von GOTHIC nicht von einer einzelnen Person, sondern von mehreren Personen entwickelt wurden. Personen, die sich im Bezug auf die Fortsetzung dieser Geschichte am Ende 2001 so uneinig waren, dass Piranha Bytes daran zerbrach.</p>

    <p>Welcher Aussage soll man nun größere Bedeutung beimessen? Ist die Aussage von THQ, welche die Marke besitzen, relevanter als die Aussage von Mike Hoge, der das Spiel erfand aber keinerlei Rechte mehr daran hat? Ist Mikes Meinung relevanter als Stefan Nyuls, der einen großen Teil der Story entwickelt hat? Ist es relevant, was "offiziell" als Gothic erschienen ist, selbst dann wenn der Rechteinhaber etwas als unkanonisch erklärt? Und spielt das eine Rolle?</p>

    <p>Unser Standpunkt ist: Es spielt überhaupt keine Rolle in einem Universum, das sowieso nicht mehr kohärent ist. PHOENIX steht jenseits dieser Konflikte. Es geht zurück zu dem Zeitpunkt, als noch alles möglich war. Der PHOENIX Kanon besteht aus den Design Dokumentationen zu Gothic, dem Gothic Comic, der Screenshot Story, Gothic 1 und dem Gothic Sequel. Auf dieser Grundlage haben wir die Lore und Geschichte weiterentwickelt und streben nach eben der Kohärenz, die GOTHIC schon lange verloren hat. Was offiziell ist oder nicht, ist für uns also vollkommen irrelevant. Für uns spielt es nur eine Rolle, was wir daraus machen.</p>

    <p>Quellen wie Schläfers Bann, <a href="https://gothicarchive.org/documents/SleepersBan.html">die Geschichte von Alex Wittmann</a>, dienen uns ebenfalls als Inspirationsquellen. Alex war von den frühen Konzepten inspiriert und hat die Geschichte in einer frühen Entwicklungsphase von GOTHIC geschrieben. Dass er nicht selbst am Spiel mitgearbeitet hat ist für uns dabei nicht relevant. Wir verwenden sämtliche Ideen wieder, die uns sinnvoll erscheinen und die Lore oder Geschichte erweitern, ohne mit den anderen Quellen (Design Dokumente, Spiel, Comic usw.) in Konflikt zu geraten.</p>
    <p>Das gleiche gilt für <a href="https://gothicarchive.org/demos/finster/" target="_blank">Finster</a>. Die Finster Demo mag zwar keinen direkten Bezug zu Gothic haben, nichtdestotrotz haben die Mad Scientists eine nicht zu unterschätzende Rolle in der Entwicklung von Gothic gespielt; ohne sie und ihre Demo hätte es Gothic nie gegeben. Darum verwenden wir auch Ideen wieder, die wir in Finster finden. In einem Fall mag das nur ein Easteregg sein, in einem anderen Fall ein wichtiges Element der Story und Lore.</p>
  </details>
-->
...
<ul class="features"><h3>ORPHEUS</h3>
  ...
  <li>Die ursprüngliche Story mit ihren zentralen Events nacherzählt (OMFull, FMTaken, OrcAssault, Nemesis)</li>
  <li>Komplett spielbar als eine der vier angekündigten Klassen: Magier, Dieb, Krieger oder Psioniker</li>
  <li>Neue Gilden für den Spieler: Buddler, Schürfer, Psioniker und ein paar geheime Gilden</li>
  <li>Aus alten Interviews und Screenshots bekannte Inhalte und Situationen und von den Handlungen des Spielers oder anderer Charaktere abhängige Skriptereignisse</li>
  <li>Keine Level, Erfahrungspunkte oder Lernpunkte; ein völlig anderes Gameplay und eine neue Art der Charakterprogression um die verworfenen Alpha Attribute (Ausdauer, Wahnsinn, Willenskraft, Arkane Kunst, Diebeskunst, Kampfkunst), durch unser learning-by-acting System (verbessere deinen Charakter durch Spielen in Übereinstimmung mit deiner gewählten Rolle) und durch die Re-Integration der zwei Formen der Magie (Runenmagie und Psionik als getrennte Systeme)</li>
  <li>Survivalelemente, wie zum Teil bekannt aus der Alpha, zum Teil von uns weiterentwickelt: Begrenztes Inventar, Regeneration, Abnutzung, Verwelken, Verwesen etc.</li></li>
  <li>Modular Armor Illusion System (Progressive Rüstungsverbesserung, Kapuzen usw.)</li>
  <li>Weiterentwicklung der Visualisierung bzw. des optischen Feedbacks, also noch mehr Animationen, noch weniger Statistik, noch weniger Texteinblendungen</li>
  <li>Noch immersiveres Crafting, z.B. Alchemie in einzelnen, animierten Schritten</li>
  <li>Diverse alte und neue Skills: Alchemie, Sprinten, Axtkampf, Dolchkampf, Meucheln, Meister des Feuers, Pflanzen-/Pilzkunde, Monster ablenken, Monster zähmen, Eiserner Wille, Orkische Sprache usw.</li>
  <li>Verbesserte Unterwelt (keine leeren Höhlen, jede Höhle mit eigener Belichtung und individueller Gestaltung)</li>
  <li>Beseitigung von Logikfehlern (13. Zauberer, Spaltung der Magier usw.), Grammatikfehlern und Bugfixing</li>
  <li>Mehr Detaildichte und dezentes Overhaul der Vegetation</li>
  <li>Pflanzen wachsen jetzt in Gruppen und an für sie typischen Orten, gemäß den Konzepten von Stefan Nyul
  <li>Erweiterte Tagesabläufe für NPCs</li>
  <li>Verbesserte AI</li>
  <li>Keine Cutscenes; alles läuft in Echtzeit ab</li>
  <li>Charakter-Auswahl</li>
  <li>Optionales Icon-HUD aus der frühen Alpha</li>
  <li>Alpha Soundtrack von Kai Rosenkranz (KaiRo)</li>
  <li>uvm.</li>
  </ul>
-->
...
<!--
  ...
  <li>Vier zum Teil sehr unterschiedliche Plots abhängig von der im Spiel gewählten Klasse, durch die man die komplexe Story jeweils aus einer anderen Perspektive erlebt; jeder Plot eröffnet eine neue Sichtweise auf das Spiel</li>
  <li>Neue Spielergilden (Bettler, Mystiker, Arbeiter, Rekrut, (Dämonen)jäger, Legionär, Ordinator, …)</li>
  <li>Große Vielfalt neuer NPCs und Gilden, tiefgründige Charaktere und Charakterentwicklung</li>
  <li>Umfangreiche und detailverliebte Erweiterung der Lore mit Anknüpfung an zahlreiche lose Fäden der Vorlage</li>
  <li>Zum Teil handgeschriebene Schriftstücke und handgezeichnete Ingame-Artworks</li>
  <li>Neues Animationsrepertoire</li>
  <li>Zahlreiche neue Bücher und sonstige Schriften</li>
  <li>Konsequente Weiterentwicklung des Wabi-Sabi Artstyles; die Kolonie ist düsterer und mystischer als je zuvor</li>
  <li>Neue mit der Story und dem Gameplay verknüpfte Vegetation</li>
  <li>Verworfene Skills aus dem Sequel (Rüstungsbau, Bogenbau, Kochkunst, erweiterter Runenbau, Stabkampf) und neue Skills (Akrobatik II und III, erweitertes Schmieden, Schildkampf, Spruchrollen schreiben)</li>
  <li>Neue Monster (dämonische Varianten aus dem Sequel, untote Varianten und gänzlich neue Monster)</li>
  <li>Neue Items (Pflanzen, Nahrungsmittel, Rüstungen, Roben, Pfeilsorten usw.)</li>
  <li>Zwei neue und ein paar überarbeitete Dungeons</li>
  <li>Neuer Soundtrack mit Samples von KaiRo, basierend auf den Ansätzen von Marco Rademacher</li>
  </ul>
  </details>
-->
...
The situation is totally different with Gothic and the original Gothic MDK, to which the Gothic 2 license does not apply. Instead there are simple terms of use, that only forbid any kind of commercial use of assets created with the help of the MDK; that's it. If you create something completely on your own, without the use of existing assets, you retain complete rights of them even after publishing them in the the mod/game. You keep having the rights over your assets and modifications; no one is allowed to sell your work and the rightholder is also not able to change these conditions retroactively because the Gothic MDK shipped under these conditions which do not contain any clause that would allow such retroactive changes of the conditions. It would not legally hold up. Therefore, as far as Gothic is concerned, the terms of use that the MDK shipped with, are all that matters, legally forever.
...
<!--
  <details>
  <a id="support"></a>
  <summary>Wie kann man euch unterstützen?</summary>
  <p>Wenn ihr aktiv bei der Arbeit am Projekt mitwirken wollt, könnt ihr <a href="/contrib.html">hier diverse Aufgaben</a> finden, für die wir Unterstützung brauchen. Zudem könnt ihr uns spenden. Spenden helfen uns dabei, unsere Kosten zu decken, die uns durch die Websiten, das Gothic Archiv, Backups, Equipment usw. entstehen. Kleine, aber regelmäßige Beträge sind eine große Hilfe und ermöglichen es uns, mehr Zeit in das Projekt zu investieren.<br> 
  Wenn ihr uns finanziell unterstützen möchtet, könnt ihr uns per PayPal Spenden an unsere Mail Adresse (mail@phoenixtales.de) senden.</p>
  </details>
-->
